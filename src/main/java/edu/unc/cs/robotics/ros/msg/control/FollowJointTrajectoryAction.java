...
@MessageSpec(
    type = FollowJointTrajectoryAction.DATATYPE,
    md5sum = FollowJointTrajectoryAction.MD5SUM,
    definition = FollowJointTrajectoryAction.DEFINITION
)
public class FollowJointTrajectoryAction extends Message {
    public static final String DATATYPE = "control_msgs/FollowJointTrajectoryAction";
    public static final String MD5SUM = "bc4f9b743838566551c0390c65f1a248";
    ...
    public FollowJointTrajectoryActionGoal actionGoal;
    public FollowJointTrajectoryActionResult actionResult;
    public FollowJointTrajectoryActionFeedback actionFeedback;

    public FollowJointTrajectoryAction() {

    }

    public FollowJointTrajectoryAction(MessageDeserializer buf) {
        this.actionGoal = new FollowJointTrajectoryActionGoal(buf);
        this.actionResult = new FollowJointTrajectoryActionResult(buf);
        this.actionFeedback = new FollowJointTrajectoryActionFeedback(buf);
    }

    @Override
    public void serialize(MessageSerializer buf) {
        actionGoal.serialize(buf);
        actionResult.serialize(buf);
        actionFeedback.serialize(buf);
    }

    @Override
    public String toString() {
        return "FollowJointTrajectoryAction{" +
